...
export const FindReplacePanel = observer(function FindReplacePanel({
  ...
  const field =
    "h-8 w-full rounded-le-md border border-le-ink-200 px-2 text-[13px] text-le-ink-800 outline-none focus:border-le-ink-400";
  const button =
    "flex h-8 items-center justify-center rounded-le-md border border-le-ink-200 px-2.5 text-[12px] text-le-ink-700 transition-colors hover:bg-le-ink-50 disabled:cursor-not-allowed disabled:opacity-40";

  return (
    <div
      data-dp-find-replace
      className="absolute right-4 top-4 z-40 w-[292px] rounded-le-lg border border-le-ink-200 bg-le-surface p-3 shadow-lg"
      onKeyDown={(e) => {
    ...
    >
      <div className="mb-2 flex items-center justify-between">
        <span className="text-[12px] font-le-medium text-le-ink-500">
        ...
        <button
          ...
          className="rounded p-0.5 text-le-ink-400 hover:bg-le-ink-100 hover:text-le-ink-700"
        >
          <X size={14} />
        </button>
      </div>
      ...
      <div className="flex items-center gap-1.5">
        ...
        <button
          ...
          className={`${button} shrink-0 ${caseSensitive ? "bg-le-ink-900 text-le-on-accent hover:bg-le-ink-900" : ""}`}
        >
      ...
      <div className="mt-2 flex items-center justify-between">
        <span
          ...
          className="text-[12px] tabular-nums text-le-ink-500"
        >
          {matches.length
      ...
      <p className="mt-2 text-[11px] leading-relaxed text-le-ink-400">
