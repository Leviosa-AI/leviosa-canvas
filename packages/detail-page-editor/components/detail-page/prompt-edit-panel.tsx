...
export function PromptEditPanel({
  ...
  return (
    <div className="relative flex flex-col overflow-hidden rounded-le-xl border border-le-ink-200 bg-le-surface">
      <div className="flex items-center gap-1.5 border-b border-le-ink-200 px-3 py-2">
        <Sparkles size={13} className="text-le-ai" />
        <span className="text-xs font-le-medium text-le-ink-900">{t("detailPage.promptEdit.header")}</span>
