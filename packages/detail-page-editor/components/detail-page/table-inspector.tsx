    ...
    <>
        ...
        <div>
          ...
          {isGrid ? (
            <div className="flex items-center gap-1.5 pb-1.5">
              ...
              <button
                ...
                className="shrink-0 rounded-le-md p-1.5 text-le-ink-400 hover:bg-le-ink-100 hover:text-le-ink-700 disabled:opacity-30"
              >
          ...
          <div className="mt-2 flex gap-1.5">
            <button
              ...
              className="flex flex-1 items-center justify-center gap-1 rounded-le-md border border-le-ink-200 py-1.5 text-xs text-le-ink-600 hover:bg-le-ink-50 disabled:opacity-40"
            >
          ...
          <p className="mt-2 text-[11px] text-le-ink-400">
          ...
          {spec.style.columnWidths ? (
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1 rounded-le-md border border-le-ink-200 px-2 py-1.5 text-xs text-le-ink-600 hover:bg-le-ink-50"
              >
      ...
      <Section title={t("detailPage.table.colors")}>
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2">
            <span className="w-20 shrink-0 text-[11px] text-le-ink-500">
      ...
      <Section title={t("detailPage.table.detach")}>
        <button
          ...
          className="flex w-full items-center justify-center gap-1.5 rounded-le-md border border-le-ink-200 py-1.5 text-xs text-le-ink-600 hover:bg-le-ink-50"
        >
